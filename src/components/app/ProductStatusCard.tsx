...
const TYPE_STYLES: Record<string, string> = {
  ...
  drug: "bg-indigo-500/10 text-indigo-700 border-indigo-500/20",
  medical_device: "bg-cyan-500/10 text-cyan-700 border-cyan-500/20",
  biologic: "bg-rose-500/10 text-rose-700 border-rose-500/20",
  tobacco: "bg-slate-500/10 text-slate-700 border-slate-500/20",
  veterinary: "bg-orange-500/10 text-orange-700 border-orange-500/20",
};
