...
| **Phase 2 FDA Fetchers (IA, Guidance, Regs.gov)** | **2026-03-09** | **Shipped — 3 new data sources. Import alerts: 154 items (scrape FDA listing). Guidance documents: 2,761 items (static JSON, DataTables WAF-blocked). Regulations.gov: 1,178 items/month (REST API, FR dedup, X-Api-Key auth). Inngest daily-ingest now 7 parallel fetchers. Migration `006_add_phase2_sources`. Total: ~4,093 new regulatory items.** |
