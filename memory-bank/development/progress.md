...
Maintainer: RB
Status: Active — Intelligence pages live, ingredient backfill in progress (13/25 published). Phase 2 fetchers shipped. Content automation live. Fact-checking deployed.
---
...
| **Intelligence Pages (Programmatic SEO)** | **2026-03-12** | **Live — 3 surfaces (`/ingredients/`, `/enforcement/`, `/regulations/`). Migration `007_intelligence_pages.sql` applied. 13/25 ingredient pages published. Content pipeline: subagent generate → subagent fact-check → apply corrections → publish via Supabase upsert. Pages: red-no-3, cbd-cannabidiol, titanium-dioxide, red-40, yellow-5, yellow-6, bha, potassium-bromate, blue-1, blue-2, green-3, propylparaben, aspartame. In progress: azodicarbonamide, sucralose, sodium-nitrite, carrageenan, talc. Remaining: formaldehyde, kratom, lead, nmn, brominated-vegetable-oil. Enforcement + regulation pages pending.** |
