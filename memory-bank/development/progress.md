...
Maintainer: RB
Status: Active — Ingredient pages complete (25/25 published, ~51,750 words). Enforcement backfill next (23 companies). Phase 2 fetchers shipped. Content automation live.
---
...
| **Intelligence Pages (Programmatic SEO)** | **2026-03-12** | **Live — 3 surfaces (`/ingredients/`, `/enforcement/`, `/regulations/`). Migration `007_intelligence_pages.sql` applied. All 25 ingredient pages published (~51,750 words). Data gathering complete for enforcement (23 companies) and regulations (10 topics). Content pipeline: subagent generate → fact-check → corrections → Supabase upsert. Ingredients: red-no-3, cbd-cannabidiol, titanium-dioxide, red-40, yellow-5, yellow-6, bha, potassium-bromate, blue-1, blue-2, green-3, propylparaben, aspartame, azodicarbonamide, sucralose, sodium-nitrite, carrageenan, talc, formaldehyde, kratom, lead, nmn, brominated-vegetable-oil, pfas, parabens. Enforcement + regulation content generation next.** |
