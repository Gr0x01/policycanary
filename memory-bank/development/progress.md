...
Maintainer: RB
Status: Active — Ingredient (25/25, ~51,750 words) and enforcement (10/10, ~18,000 words) pages complete. Regulation backfill next. Phase 2 fetchers shipped. Content automation live.
---
...
| **Intelligence Pages (Programmatic SEO)** | **2026-03-12** | **Live — 3 surfaces (`/ingredients/`, `/enforcement/`, `/regulations/`). Migration `007_intelligence_pages.sql` applied. 25 ingredient + 10 enforcement pages published (~69,750 words total). Content pipeline: subagent generate → fact-check → corrections → Supabase upsert. Ingredients (25): red-no-3, cbd-cannabidiol, titanium-dioxide, red-40, yellow-5, yellow-6, bha, potassium-bromate, blue-1, blue-2, green-3, propylparaben, aspartame, azodicarbonamide, sucralose, sodium-nitrite, carrageenan, talc, formaldehyde, kratom, lead, nmn, brominated-vegetable-oil, pfas, parabens. Enforcement (10): grimmway-farms, dollar-general, fresh-ready-foods-freshrealm, resers-fine-foods, albertsons, sysco, danone, fgf-brands, deep-foods, wells-enterprises. Regulation content generation next.** |
