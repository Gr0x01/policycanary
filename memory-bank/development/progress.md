...
Maintainer: RB
Status: Active — Phase 2 fetchers shipped. Weekly email on Inngest. PostHog + Sentry instrumented. Pilot Monitoring dashboard ready.
---
...
| **Clawdbot (OpenClaw) Deployed** | **2026-03-05** | **Live — Vultr VPS (108.61.151.130), Discord bot on Bizniz server, 5 cron jobs (weekly-roundup Fri 9AM, seo-blog-tuesday Tue 10AM, linkedin-monday Mon 10AM, linkedin-wednesday Wed 10AM), blog publish pipeline, LinkedIn draft pipeline. `scripts/clawdbot/` in repo.** |
